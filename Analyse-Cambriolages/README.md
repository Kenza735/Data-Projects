# Évolution des cambriolages en France (2016-2025)
...
Ces données viennent du site data.gouv.fr et couvrent une période de 10 ans, avec une fréquence mensuelle, allant de janvier 2016 à décembre 2025, soit 121 observations.

## Ce dépôt contient les ressources suivantes :
- **Traitement & Nettoyage :** Filtrage et préparation des variables en lien avec le cambriolage sur **Excel**.
